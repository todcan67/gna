...
function simple_boostrap_register_sidebars() {
    ...
    register_sidebar(array(
      'id' => 'bottom1',
      'name' => __('Bottom', 'simple-bootstrap'),
      'before_widget' => '<div id="%1$s" class="widget col-xs-12 %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h4 class="widgettitle">',
      'after_title' => '</h4>',
    ...
    register_sidebar(array(
      'id' => 'center-hero',
      'name' => __('Hero', 'simple-bootstrap'),
      'before_widget' => '<div id="%1$s" class="widget col-xs-12 lead %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h1 class="cover-heading">',
      'after_title' => '</h1>',
    ));
    register_sidebar(array(
      'id' => 'disclosure',
      'name' => __('Disclosure', 'simple-bootstrap'),
      'before_widget' => '<div id="%1$s" class="widget col-xs-12 %2$s">',
      'after_widget' => '</div>',
    ...
    register_sidebar(array(
      'id' => 'follow-us',
      'name' => __('Follow Us', 'simple-bootstrap'),
      'before_widget' => '<div id="%1$s" class="widget col-xs-12 %2$s">',
      'after_widget' => '</div>',
      'before_title' => '<h2 class="widgettitle text-right">',
      'after_title' => '</h2>',
    ));
...
function simple_boostrap_display_post($multiple_on_page) { ?>
    ...
    <article id="post-<?php the_ID(); ?>" <?php post_class("block"); ?> role="article">
        ...
        <header>
            ...
            <div class="featured-image excerptImage">
                <?php if ($multiple_on_page) : ?>
                <a class="postImgLink" href="<?php the_permalink() ?>" title="<?php the_title_attribute(); ?>"><?php the_post_thumbnail('simple_boostrap_featured'); ?></a>
                <?php else: ?>
        ...
        <section class="post_content">
            ...
            if ($multiple_on_page) {
                the_excerpt();
                echo '<p class="readMorePostButton"><a class="btn btn-default btn-sm" href="';
                echo the_permalink() ;
